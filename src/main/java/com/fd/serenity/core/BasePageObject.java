...
public class BasePageObject extends PageObject {
	...
	public void Clear_SendKeys(WebElementFacade element, String send_text) {
		element.waitUntilEnabled().type(send_text);
	}
	
	public void Clear_SendKeys_Enter(WebElementFacade element, String send_text) {
		element.waitUntilEnabled().typeAndEnter(send_text);
	}

	public void setImplicitWait() {
		getDriver().manage().timeouts().implicitlyWait(ConfigParameters.implicit_wait, TimeUnit.SECONDS);
	}
	...
	public void SwitchToFrame(WebElementFacade element){
		WebDriverWait wait = new WebDriverWait(getDriver(), ConfigParameters.explicit_wait);
